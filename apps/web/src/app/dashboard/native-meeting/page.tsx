  ...
  const recentMeetings = [
    {
      ...
      participants: [
        {
          initials: "ET",
          color: "bg-indigo-950 text-indigo-400 border-indigo-900/50",
        },

        {
          initials: "SK",
          color: "bg-indigo-900 text-indigo-300 border-indigo-800/50",
        },

        {
          initials: "+3",
          color: "bg-slate-800 text-slate-200 border-slate-700/50",
        },
      ],
...

    {
      ...
      participants: [
        ...
        {
          initials: "MK",
          color: "bg-slate-700 text-slate-300 border-slate-600/50",
        },
      ],
  ...
  const meetingTemplates = [
    {
      ...
      duration: "15m",
      participants: "2–4",
      desc: "Fast sync with instant translation",
    },

    {
      ...
      duration: "30m",
      participants: "5–10",
      desc: "Daily or weekly team check-in",
    },

    {
      ...
      duration: "45m",
      participants: "3–8",
      desc: "External meeting with live captions",
    },

    {
      ...
      duration: "90m",
      participants: "10–30",
      desc: "Collaborative session with whiteboard",
    },
  ];
    ...
    <>
      <main className="flex-1 min-w-0 flex flex-col h-screen overflow-hidden relative">
        ...
        <DashboardHeader
          searchPlaceholder={
            isOrganization()
              ? "Search team meetings, transcripts..."
              : "Search meetings, transcripts, or people..."
          }
        />
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-500 text-sm mb-6 leading-relaxed">
                      Enter a Relay link or ID to instantly connect with
                  ...
                  {filteredMeetings.map((meeting) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="material-symbols-outlined text-[#c4c7c7] text-[18px] group-hover:text-[#FF416C] transition-colors">
                          arrow_forward
                        </span>
                      </div>
                    </Link>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  <div>
                    ...
                    <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-[#FF416C] to-[#FF4B2B] rounded-full"
                        style={{ width: "42%" }}
                      />
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {meetingTemplates.map((template) => (
                  <button
                    ...
                    className="group bg-[#FFFDF8] border border-[#E4E0D6]/30 rounded-2xl p-5 text-left hover:border-[#FF416C]/30 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
                  >
