  ...
  const recentMeetings = [
    {
      ...
      participants: [
        ...
        {
          initials: "+3",
          color: "bg-chrome text-white/70 border-chrome-raised",
        },
      ],
...

    {
      ...
      participants: [
        ...
        {
          initials: "MK",
          color: "bg-chrome-raised text-faint border-chrome-raised",
        },
      ],
                ...
                {meetingTemplates.map((template) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5 mt-3">
                      <span className="material-symbols-outlined text-muted text-[14px]">
                        group
                      </span>
