...
function VerifyEmailInner() {
    ...
    return (
      <div className="min-h-screen bg-[#FAF9F5] flex items-center justify-center font-helvetica">
        <div className="text-center space-y-6 max-w-md mx-auto px-6">
          ...
          <p className="text-slate-500">The email verification link is missing or invalid.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F5] flex items-center justify-center font-helvetica">
      <div className="text-center space-y-6 max-w-md mx-auto px-6">
        <div className="w-16 h-16 mx-auto bg-white rounded-2xl flex items-center justify-center shadow-sm border border-[#E4E0D6]/30">
