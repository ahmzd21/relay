  ...
  return (
    <div className="min-h-screen text-[#1c1b1b] selection:bg-black selection:text-white overflow-x-hidden font-helvetica">
      ...
      <div className="flex flex-col lg:flex-row lg:h-screen lg:overflow-hidden min-h-screen">
        ...
        <main className="relative z-10 w-full lg:w-[50%] flex flex-col justify-between items-center p-[24px] md:p-[40px] bg-[#FAF9F5] min-h-screen">
          ...
          <div className="relative z-10 w-full max-w-[420px] my-auto py-12 space-y-[40px] lg:space-y-[32px]">
            <div className="text-left">
              <h1 className="text-[36px] lg:text-[48px] font-bold font-helvetica mb-[8px] text-slate-900 tracking-tight">Join Relay</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-[16px]">
              ...
              <div className="space-y-[4px]">
                <label className="block text-[10px] uppercase tracking-[0.1em] font-bold font-['Inter'] text-slate-400 ml-4 mb-2">Full Name</label>
                <input
              ...
              <div className="space-y-[4px]">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                  />
                  <button className="absolute right-6 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-900 transition-colors" type="button">
              ...
              <button type="button" className="flex items-center justify-center gap-3 w-full py-4 px-6 border border-[#c4c7c7]/60 rounded-full font-medium bg-white hover:bg-white transition-all duration-300 shadow-sm">
                ...
                <span className="text-slate-900 text-[15px] font-semibold">Continue with Google</span>
              </button>
            </form>
